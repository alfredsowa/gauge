...
const AddSupplierModal = ({setSupplierList}:{
  ...
  return (
    ...
    title={<Text fw={600} fz={17}>Add New Supplier</Text>}
    overlayProps={{
      ...
      />
        ...
        <Button variant='filled' onClick={addNewSupplier} rightSection={<IconTruckDelivery size={16} />}>Add Supplier</Button>
    </>
  )
}
